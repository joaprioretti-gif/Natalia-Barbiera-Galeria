...
const artworks: Artwork[] = [
  {
    ...
    descripcion: "Obra abstracta original de Natalia Barbiera, perteneciente a esta exposición abstracta.",
    ...
    <main>
      <header className="site-header">
        ...
        <Sheet open={menuOpen} onOpenChange={setMenuOpen}>
          ...
          <SheetContent className="mobile-sheet" side="right">
            ...
            <div className="mobile-sheet-foot">Exposición abstracta · 14 obras</div>
          </SheetContent>
        </Sheet>
      </header>
      ...
      <section className="hero" id="inicio" aria-labelledby="hero-title">
        <div className="hero-copy" data-reveal>
          <p className="eyebrow">Exposición abstracta · Argentina</p>
          <h1 id="hero-title">
            Natalia
            <br />
            <em>Barbiera</em>
